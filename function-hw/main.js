...
for (var i=0;i<ages.length;i++) { console.log(ages[i]);  }
...
for (var i=younger.length-1;i>=0;) {
...
var i=0;
// part1
while (i<ages.length) { console.log(ages[i++]);  }
...
for (var i=0;i<=8;i++) { console.log(i+": "+getDayOfWeek(i)); }
...
function addPepperoniToPizza(ingredientsArray) {
  var index= ingredientsArray.indexOf("pepperoni");
  //if (index<0) { ingredientsArray.push("pepperoni"); }
  if (index===-1) { ingredientsArray.push("pepperoni"); }
  return ingredientsArray;
}

var ingredients1= ['onions', 'olives', 'pineapple'];
var ingredients2= ['spinach', 'pepperoni', 'mushrooms'];
console.log(addPepperoniToPizza(ingredients1));
console.log(addPepperoniToPizza(ingredients2));
