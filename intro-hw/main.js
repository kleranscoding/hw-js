...
var greeting= "Hello I'm Kevin, I'm 28 years old and live in San Francisco, California";
...
var greeting2= `Hello I\'m ${name}, I\'m ${age} and I live in ${address}`;
...
/*
- define highestNumber to keep track of the largest number seen so far
loop through the array
- for each loop round:
- update the largest number if the current element is larger than highestNumber
- print highestNumber
*/
...
// 	highestNumber= Math.max(highestNumber,numbers[k]);
// }

// var k=0;
// for (;k++<numbers.length;) {
//     if (numbers[k]>highestNumber) highestNumber= numbers[k]; 
// }
